...
write /sys/devices/system/cpu/cpu5/cpufreq/scaling_governor chill
restorecon -R /sys/devices/system/cpu
...
write /sys/devices/system/cpu/cpu6/cpufreq/scaling_governor chill
restorecon -R /sys/devices/system/cpu
...
write /sys/devices/system/cpu/cpu7/cpufreq/scaling_governor chill
restorecon -R /sys/devices/system/cpu
